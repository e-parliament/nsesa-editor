 ...
 */
public class AmendmentBody extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private java.util.List<AmendmentBody> amendmentBodyElements = new ArrayList<AmendmentBody>();

// CONSTRUCTORS ------------------

    public AmendmentBody(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public java.util.List<AmendmentBody> getAmendmentBodyElement() {
        return amendmentBodyElements;
    }

    public void setAmendmentBodyElement(final java.util.List<AmendmentBody> amendmentBodyElements) {
        this.amendmentBodyElements = amendmentBodyElements;
    }
