 ...
 */
public class DocCommittee extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private java.util.List<DocCommittee> docCommitteeElements = new ArrayList<DocCommittee>();

// CONSTRUCTORS ------------------

    public DocCommittee(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public java.util.List<DocCommittee> getDocCommitteeElement() {
        return docCommitteeElements;
    }

    public void setDocCommitteeElement(final java.util.List<DocCommittee> docCommitteeElements) {
        this.docCommitteeElements = docCommitteeElements;
    }
