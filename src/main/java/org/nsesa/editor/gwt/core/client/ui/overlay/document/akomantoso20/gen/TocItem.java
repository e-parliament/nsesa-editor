 ...
 */
public class TocItem extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private java.util.List<TocItem> tocItemElements = new ArrayList<TocItem>();

// CONSTRUCTORS ------------------

    public TocItem(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public void setLevelAttribute(final Integer levelAttribute) {
    ...
    public java.util.List<TocItem> getTocItemElement() {
        return tocItemElements;
    }

    public void setTocItemElement(final java.util.List<TocItem> tocItemElements) {
        this.tocItemElements = tocItemElements;
    }
