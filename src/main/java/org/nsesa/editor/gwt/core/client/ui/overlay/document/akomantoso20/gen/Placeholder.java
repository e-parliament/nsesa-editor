 ...
 */
public class Placeholder extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {

// FIELDS ------------------

    private String originalTextAttribute;
    ...
    private java.util.List<Placeholder> placeholderElements = new ArrayList<Placeholder>();

// CONSTRUCTORS ------------------

    public Placeholder(final Element amendableElement) {
        super(amendableElement);
    }

// ACCESSORS ------------------

    public String getOriginalTextAttribute() {
        return originalTextAttribute;
    }

    public void setOriginalTextAttribute(final String originalTextAttribute) {
        this.originalTextAttribute = originalTextAttribute;
    }
    ...
    public java.util.List<Placeholder> getPlaceholderElement() {
        return placeholderElements;
    }

    public void setPlaceholderElement(final java.util.List<Placeholder> placeholderElements) {
        this.placeholderElements = placeholderElements;
    }
