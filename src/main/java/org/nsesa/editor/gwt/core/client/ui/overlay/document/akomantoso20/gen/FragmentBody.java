 ...
 */
public class FragmentBody extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private FragmentBody fragmentBodyElement;

// CONSTRUCTORS ------------------

    public FragmentBody(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public FragmentBody getFragmentBodyElement() {
        return fragmentBodyElement;
    }

    public void setFragmentBodyElement(final FragmentBody fragmentBodyElement) {
        this.fragmentBodyElement = fragmentBodyElement;
    }
