 ...
 */
public class Interstitial extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private java.util.List<Note> noteElements = new ArrayList<Note>();
    private java.util.List<Div> divElements = new ArrayList<Div>();
    private java.util.List<Interstitial> interstitialElements = new ArrayList<Interstitial>();

// CONSTRUCTORS ------------------

    public Interstitial(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public java.util.List<Note> getNoteElement() {
        return noteElements;
    }

    public void setNoteElement(final java.util.List<Note> noteElements) {
        this.noteElements = noteElements;
    }

    public java.util.List<Div> getDivElement() {
        return divElements;
    }

    public void setDivElement(final java.util.List<Div> divElements) {
        this.divElements = divElements;
    }

    public java.util.List<Interstitial> getInterstitialElement() {
        return interstitialElements;
    }

    public void setInterstitialElement(final java.util.List<Interstitial> interstitialElements) {
        this.interstitialElements = interstitialElements;
    }
