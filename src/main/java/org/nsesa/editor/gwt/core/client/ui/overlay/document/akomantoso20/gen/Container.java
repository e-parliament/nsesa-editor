 ...
 */
public class Container extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private java.util.List<Container> containerElements = new ArrayList<Container>();

// CONSTRUCTORS ------------------

    public Container(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public java.util.List<Container> getContainerElement() {
        return containerElements;
    }

    public void setContainerElement(final java.util.List<Container> containerElements) {
