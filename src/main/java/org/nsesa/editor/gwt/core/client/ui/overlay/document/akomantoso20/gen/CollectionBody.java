 ...
 */
public class CollectionBody extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private java.util.List<CollectionBody> collectionBodyElements = new ArrayList<CollectionBody>();

// CONSTRUCTORS ------------------

    public CollectionBody(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public java.util.List<CollectionBody> getCollectionBodyElement() {
        return collectionBodyElements;
    }

    public void setCollectionBodyElement(final java.util.List<CollectionBody> collectionBodyElements) {
        this.collectionBodyElements = collectionBodyElements;
    }
