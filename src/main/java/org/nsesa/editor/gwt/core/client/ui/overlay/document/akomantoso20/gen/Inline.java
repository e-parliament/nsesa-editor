 ...
 */
public class Inline extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private java.util.List<Inline> inlineElements = new ArrayList<Inline>();

// CONSTRUCTORS ------------------

    public Inline(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public java.util.List<Inline> getInlineElement() {
        return inlineElements;
    }

    public void setInlineElement(final java.util.List<Inline> inlineElements) {
