 ...
 */
public class QuotedText extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private java.util.List<QuotedText> quotedTextElements = new ArrayList<QuotedText>();

// CONSTRUCTORS ------------------

    public QuotedText(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public java.util.List<QuotedText> getQuotedTextElement() {
        return quotedTextElements;
    }

    public void setQuotedTextElement(final java.util.List<QuotedText> quotedTextElements) {
        this.quotedTextElements = quotedTextElements;
    }
