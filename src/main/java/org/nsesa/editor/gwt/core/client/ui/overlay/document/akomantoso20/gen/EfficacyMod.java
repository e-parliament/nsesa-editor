...
import org.nsesa.editor.gwt.core.client.ui.overlay.xml.EfficacyMods;
 ...
 */
public class EfficacyMod extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {

// FIELDS ------------------

    private EfficacyMods typeAttribute;
    ...
    private EfficacyMod efficacyModElement;

// CONSTRUCTORS ------------------

    public EfficacyMod(final Element amendableElement) {
        super(amendableElement);
    }

// ACCESSORS ------------------

    public EfficacyMods getTypeAttribute() {
        return typeAttribute;
    }

    public void setTypeAttribute(final EfficacyMods typeAttribute) {
    ...
    public EfficacyMod getEfficacyModElement() {
        return efficacyModElement;
    }

    public void setEfficacyModElement(final EfficacyMod efficacyModElement) {
        this.efficacyModElement = efficacyModElement;
    }
