 ...
 */
public class Ul extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private Ul ulElement;
    private Ol olElement;

// CONSTRUCTORS ------------------

    public Ul(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public Ul getUlElement() {
        return ulElement;
    }

    public void setUlElement(final Ul ulElement) {
        this.ulElement = ulElement;
    }

    public Ol getOlElement() {
        return olElement;
    }

    public void setOlElement(final Ol olElement) {
