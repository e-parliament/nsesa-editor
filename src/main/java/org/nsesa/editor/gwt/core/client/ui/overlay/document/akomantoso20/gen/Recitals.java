 ...
 */
public class Recitals extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private Recitals recitalsElement;

// CONSTRUCTORS ------------------

    public Recitals(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public Recitals getRecitalsElement() {
        return recitalsElement;
    }

    public void setRecitalsElement(final Recitals recitalsElement) {
        this.recitalsElement = recitalsElement;
    }
