 ...
 */
public class Session extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private java.util.List<Session> sessionElements = new ArrayList<Session>();

// CONSTRUCTORS ------------------

    public Session(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public java.util.List<Session> getSessionElement() {
        return sessionElements;
    }

    public void setSessionElement(final java.util.List<Session> sessionElements) {
