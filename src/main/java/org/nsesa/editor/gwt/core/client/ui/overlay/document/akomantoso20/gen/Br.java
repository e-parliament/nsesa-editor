 ...
 */
public class Br extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private Br brElement;

// CONSTRUCTORS ------------------

    public Br(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public Br getBrElement() {
        return brElement;
    }

    public void setBrElement(final Br brElement) {
