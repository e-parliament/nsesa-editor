 ...
 */
public class RelatedDocument extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private java.util.List<RelatedDocument> relatedDocumentElements = new ArrayList<RelatedDocument>();

// CONSTRUCTORS ------------------

    public RelatedDocument(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public java.util.List<RelatedDocument> getRelatedDocumentElement() {
        return relatedDocumentElements;
    }

    public void setRelatedDocumentElement(final java.util.List<RelatedDocument> relatedDocumentElements) {
        this.relatedDocumentElements = relatedDocumentElements;
    }
