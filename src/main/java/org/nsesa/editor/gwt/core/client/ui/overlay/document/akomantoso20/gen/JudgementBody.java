 ...
 */
public class JudgementBody extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private java.util.List<JudgementBody> judgementBodyElements = new ArrayList<JudgementBody>();

// CONSTRUCTORS ------------------

    public JudgementBody(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public java.util.List<JudgementBody> getJudgementBodyElement() {
        return judgementBodyElements;
    }

    public void setJudgementBodyElement(final java.util.List<JudgementBody> judgementBodyElements) {
        this.judgementBodyElements = judgementBodyElements;
    }
