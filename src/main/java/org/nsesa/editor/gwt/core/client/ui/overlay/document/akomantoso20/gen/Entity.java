 ...
 */
public class Entity extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private java.util.List<Entity> entityElements = new ArrayList<Entity>();

// CONSTRUCTORS ------------------

    public Entity(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public void setEntityElement(final java.util.List<Entity> entityElements) {
