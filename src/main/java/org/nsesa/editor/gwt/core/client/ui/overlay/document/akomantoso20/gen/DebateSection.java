 ...
 */
public class DebateSection extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private DebateSection debateSectionElement;

// CONSTRUCTORS ------------------

    public DebateSection(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public DebateSection getDebateSectionElement() {
        return debateSectionElement;
    }

    public void setDebateSectionElement(final DebateSection debateSectionElement) {
        this.debateSectionElement = debateSectionElement;
    }
