 ...
 */
public class Answer extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// ACCESSORS ------------------
    ...
    public DateTime getEndTimeAttribute() {
        return endTimeAttribute;
    }

    public void setEndTimeAttribute(final DateTime endTimeAttribute) {
        this.endTimeAttribute = endTimeAttribute;
    }
    ...
    public DateTime getStartTimeAttribute() {
        return startTimeAttribute;
    }

    public void setStartTimeAttribute(final DateTime startTimeAttribute) {
    ...
    public AnyURI getToAttribute() {
        return toAttribute;
    }

    public void setToAttribute(final AnyURI toAttribute) {
    ...
    public Answer getAnswerElement() {
        return answerElement;
    }

    public void setAnswerElement(final Answer answerElement) {
        this.answerElement = answerElement;
    }

    public Speech getSpeechElement() {
        return speechElement;
    }

    public void setSpeechElement(final Speech speechElement) {
        this.speechElement = speechElement;
    }

    public Question getQuestionElement() {
        return questionElement;
    }

    public void setQuestionElement(final Question questionElement) {
