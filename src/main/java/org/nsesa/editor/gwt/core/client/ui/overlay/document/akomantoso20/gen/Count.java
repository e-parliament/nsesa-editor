 ...
 */
public class Count extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private Quorum quorumElement;
    private Count countElement;

// CONSTRUCTORS ------------------

    public Count(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public Quorum getQuorumElement() {
        return quorumElement;
    }

    public void setQuorumElement(final Quorum quorumElement) {
        this.quorumElement = quorumElement;
    }

    public Count getCountElement() {
        return countElement;
    }

    public void setCountElement(final Count countElement) {
