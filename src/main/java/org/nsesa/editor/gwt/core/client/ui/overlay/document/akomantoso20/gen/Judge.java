 ...
 */
public class Judge extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private java.util.List<Judge> judgeElements = new ArrayList<Judge>();

// CONSTRUCTORS ------------------

    public Judge(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public java.util.List<Judge> getJudgeElement() {
        return judgeElements;
    }

    public void setJudgeElement(final java.util.List<Judge> judgeElements) {
        this.judgeElements = judgeElements;
    }
