 ...
 */
public class DebateBody extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private java.util.List<DebateBody> debateBodyElements = new ArrayList<DebateBody>();

// CONSTRUCTORS ------------------

    public DebateBody(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public java.util.List<DebateBody> getDebateBodyElement() {
        return debateBodyElements;
    }

    public void setDebateBodyElement(final java.util.List<DebateBody> debateBodyElements) {
        this.debateBodyElements = debateBodyElements;
    }
