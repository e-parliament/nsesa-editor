 ...
 */
public class Body extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private java.util.List<Body> bodyElements = new ArrayList<Body>();

// CONSTRUCTORS ------------------

    public Body(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public java.util.List<Body> getBodyElement() {
        return bodyElements;
    }

    public void setBodyElement(final java.util.List<Body> bodyElements) {
