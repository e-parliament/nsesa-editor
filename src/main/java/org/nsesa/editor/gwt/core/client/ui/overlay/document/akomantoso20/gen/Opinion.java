 ...
 */
public class Opinion extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {

// FIELDS ------------------

    private Language langAttribute;
    private OpinionType typeAttribute;
    ...
    private java.util.List<Opinion> opinionElements = new ArrayList<Opinion>();

// CONSTRUCTORS ------------------

    public Opinion(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public OpinionType getTypeAttribute() {
        return typeAttribute;
    }

    public void setTypeAttribute(final OpinionType typeAttribute) {
    ...
    public java.util.List<Opinion> getOpinionElement() {
        return opinionElements;
    }

    public void setOpinionElement(final java.util.List<Opinion> opinionElements) {
