 ...
 */
public class A extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private java.util.List<A> aElements = new ArrayList<A>();

// CONSTRUCTORS ------------------

    public A(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public java.util.List<A> getAElement() {
        return aElements;
    }

    public void setAElement(final java.util.List<A> aElements) {
