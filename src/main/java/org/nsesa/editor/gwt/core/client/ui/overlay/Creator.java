...
public interface Creator {
     ...
     */
    LinkedHashMap<String, AmendableWidget> getAllowedSiblings(AmendableWidget amendableWidget);
     ...
     */
    LinkedHashMap<String, AmendableWidget> getAllowedChildren(AmendableWidget amendableWidget);
}
