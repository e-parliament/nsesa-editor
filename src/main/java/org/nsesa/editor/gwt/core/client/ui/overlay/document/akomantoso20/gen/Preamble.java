 ...
 */
public class Preamble extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private java.util.List<Preamble> preambleElements = new ArrayList<Preamble>();

// CONSTRUCTORS ------------------

    public Preamble(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public java.util.List<Preamble> getPreambleElement() {
        return preambleElements;
    }

    public void setPreambleElement(final java.util.List<Preamble> preambleElements) {
        this.preambleElements = preambleElements;
    }
