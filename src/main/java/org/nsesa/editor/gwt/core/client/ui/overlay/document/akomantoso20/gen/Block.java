 ...
 */
public class Block extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private java.util.List<Block> blockElements = new ArrayList<Block>();

// CONSTRUCTORS ------------------

    public Block(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public java.util.List<Block> getBlockElement() {
        return blockElements;
    }

    public void setBlockElement(final java.util.List<Block> blockElements) {
