 ...
 */
public class Th extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private java.util.List<Th> thElements = new ArrayList<Th>();

// CONSTRUCTORS ------------------

    public Th(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public java.util.List<Th> getThElement() {
        return thElements;
    }

    public void setThElement(final java.util.List<Th> thElements) {
