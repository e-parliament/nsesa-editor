 ...
 */
public class Citation extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private Citation citationElement;
    private Item itemElement;
    private Tblock tblockElement;
    private Recital recitalElement;

// CONSTRUCTORS ------------------

    public Citation(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public Citation getCitationElement() {
        return citationElement;
    }

    public void setCitationElement(final Citation citationElement) {
        this.citationElement = citationElement;
    }

    public Item getItemElement() {
        return itemElement;
    }

    public void setItemElement(final Item itemElement) {
        this.itemElement = itemElement;
    }

    public Tblock getTblockElement() {
        return tblockElement;
    }

    public void setTblockElement(final Tblock tblockElement) {
        this.tblockElement = tblockElement;
    }

    public Recital getRecitalElement() {
        return recitalElement;
    }

    public void setRecitalElement(final Recital recitalElement) {
        this.recitalElement = recitalElement;
    }
