 ...
 */
public class Citations extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private Citations citationsElement;

// CONSTRUCTORS ------------------

    public Citations(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public Citations getCitationsElement() {
        return citationsElement;
    }

    public void setCitationsElement(final Citations citationsElement) {
        this.citationsElement = citationsElement;
    }
