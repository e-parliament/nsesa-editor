 ...
 */
public class Quantity extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private java.util.List<Quantity> quantityElements = new ArrayList<Quantity>();

// CONSTRUCTORS ------------------

    public Quantity(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public String getNormalizedAttribute() {
        return normalizedAttribute;
    }

    public void setNormalizedAttribute(final String normalizedAttribute) {
        this.normalizedAttribute = normalizedAttribute;
    }
    ...
    public java.util.List<Quantity> getQuantityElement() {
        return quantityElements;
    }

    public void setQuantityElement(final java.util.List<Quantity> quantityElements) {
