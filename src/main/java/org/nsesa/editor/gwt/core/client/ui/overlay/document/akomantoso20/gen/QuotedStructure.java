 ...
 */
public class QuotedStructure extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private AnyURI forAttribute;
    private String styleAttribute;
    private String classAttribute;
    private String titleAttribute;
    private StatusType statusAttribute;
    private AnyURI periodAttribute;
    private java.util.List<QuotedStructure> quotedStructureElements = new ArrayList<QuotedStructure>();

// CONSTRUCTORS ------------------

    public QuotedStructure(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public AnyURI getForAttribute() {
        return forAttribute;
    }

    public void setForAttribute(final AnyURI forAttribute) {
    ...
    public java.util.List<QuotedStructure> getQuotedStructureElement() {
        return quotedStructureElements;
    }

    public void setQuotedStructureElement(final java.util.List<QuotedStructure> quotedStructureElements) {
        this.quotedStructureElements = quotedStructureElements;
    }
