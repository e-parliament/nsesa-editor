 ...
 */
public class BlockList extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private BlockList blockListElement;

// CONSTRUCTORS ------------------

    public BlockList(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public BlockList getBlockListElement() {
        return blockListElement;
    }

    public void setBlockListElement(final BlockList blockListElement) {
        this.blockListElement = blockListElement;
    }
