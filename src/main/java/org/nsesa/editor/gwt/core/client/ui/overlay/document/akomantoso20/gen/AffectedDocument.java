 ...
 */
public class AffectedDocument extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private java.util.List<AffectedDocument> affectedDocumentElements = new ArrayList<AffectedDocument>();

// CONSTRUCTORS ------------------

    public AffectedDocument(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public java.util.List<AffectedDocument> getAffectedDocumentElement() {
        return affectedDocumentElements;
    }

    public void setAffectedDocumentElement(final java.util.List<AffectedDocument> affectedDocumentElements) {
        this.affectedDocumentElements = affectedDocumentElements;
    }
