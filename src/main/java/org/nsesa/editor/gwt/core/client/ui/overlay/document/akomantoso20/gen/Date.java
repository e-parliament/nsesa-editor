 ...
 */
public class Date extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private java.util.List<Date> dateElements = new ArrayList<Date>();

// CONSTRUCTORS ------------------

    public Date(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public java.util.List<Date> getDateElement() {
        return dateElements;
    }

    public void setDateElement(final java.util.List<Date> dateElements) {
