 ...
 */
public class Preface extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private java.util.List<Preface> prefaceElements = new ArrayList<Preface>();

// CONSTRUCTORS ------------------

    public Preface(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public java.util.List<Preface> getPrefaceElement() {
        return prefaceElements;
    }

    public void setPrefaceElement(final java.util.List<Preface> prefaceElements) {
        this.prefaceElements = prefaceElements;
    }
