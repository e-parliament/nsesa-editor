...
public interface OverlayWidgetWalker {
    ...
    /**
     * AmendableVisitor interface (see Visitor Pattern). Used in combination with the {@link org.nsesa.editor.gwt.core.client.ui.overlay.document.OverlayWidget#walk(OverlayWidgetWalker.OverlayWidgetVisitor)}
