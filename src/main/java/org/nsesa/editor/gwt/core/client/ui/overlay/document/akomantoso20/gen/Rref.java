 ...
 */
public class Rref extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {

// FIELDS ------------------

    private Language langAttribute;
    private AnyURI fromAttribute;
    ...
    private java.util.List<Rref> rrefElements = new ArrayList<Rref>();

// CONSTRUCTORS ------------------

    public Rref(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public AnyURI getFromAttribute() {
        return fromAttribute;
    }

    public void setFromAttribute(final AnyURI fromAttribute) {
    ...
    public java.util.List<Rref> getRrefElement() {
        return rrefElements;
    }

    public void setRrefElement(final java.util.List<Rref> rrefElements) {
        this.rrefElements = rrefElements;
    }
