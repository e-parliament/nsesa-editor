 ...
 */
public class FillIn extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private java.util.List<FillIn> fillInElements = new ArrayList<FillIn>();

// CONSTRUCTORS ------------------

    public FillIn(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public void setWidthAttribute(final String widthAttribute) {
    ...
    public java.util.List<FillIn> getFillInElement() {
        return fillInElements;
    }

    public void setFillInElement(final java.util.List<FillIn> fillInElements) {
        this.fillInElements = fillInElements;
    }
