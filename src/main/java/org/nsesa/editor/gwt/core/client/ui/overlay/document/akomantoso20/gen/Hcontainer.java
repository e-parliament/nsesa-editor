 ...
 */
public class Hcontainer extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private Hcontainer hcontainerElement;

// CONSTRUCTORS ------------------

    public Hcontainer(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public Hcontainer getHcontainerElement() {
        return hcontainerElement;
    }

    public void setHcontainerElement(final Hcontainer hcontainerElement) {
        this.hcontainerElement = hcontainerElement;
    }
