 ...
 */
public class Li extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private java.util.List<Li> liElements = new ArrayList<Li>();

// CONSTRUCTORS ------------------

    public Li(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public java.util.List<Li> getLiElement() {
        return liElements;
    }

    public void setLiElement(final java.util.List<Li> liElements) {
