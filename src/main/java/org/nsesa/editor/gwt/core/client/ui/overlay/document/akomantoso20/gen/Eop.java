 ...
 */
public class Eop extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private Integer breakatAttribute;
    private Eol eolElement;
    private Eop eopElement;

// CONSTRUCTORS ------------------

    public Eop(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public Integer getBreakatAttribute() {
        return breakatAttribute;
    }

    public void setBreakatAttribute(final Integer breakatAttribute) {
        this.breakatAttribute = breakatAttribute;
    }

    public Eol getEolElement() {
        return eolElement;
    }

    public void setEolElement(final Eol eolElement) {
        this.eolElement = eolElement;
    }

    public Eop getEopElement() {
        return eopElement;
    }

    public void setEopElement(final Eop eopElement) {
        this.eopElement = eopElement;
    }
