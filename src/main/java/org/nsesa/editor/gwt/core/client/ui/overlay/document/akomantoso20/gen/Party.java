 ...
 */
public class Party extends org.nsesa.editor.gwt.core.client.ui.overlay.document.AmendableWidgetImpl {
...
// FIELDS ------------------
    ...
    private java.util.List<Party> partyElements = new ArrayList<Party>();

// CONSTRUCTORS ------------------

    public Party(final Element amendableElement) {
...
// ACCESSORS ------------------
    ...
    public java.util.List<Party> getPartyElement() {
        return partyElements;
    }

    public void setPartyElement(final java.util.List<Party> partyElements) {
